...
docker build -f Dockerfile -t ctf-party --build-arg ctf-party_VERSION=5.0.0 .
```
...
# specific tag
docker pull noraj/ctf-party:5.0.0
```
...
# specific tag
docker pull ghcr.io/noraj/ctf-party:5.0.0
```
...
# specific tag
docker pull registry-intl.eu-central-1.aliyuncs.com/noraj/ctf-party:5.0.0
```
...
# specific tag
docker pull quay.io/noraj/ctf-party:5.0.0
```
...
Just replace `5.0.0` with the gem version you see after `gem build`.
...
gem install ctf-party-5.0.0.gem
```
